package android.example.my_countdown_timer

import android.example.my_countdown_timer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    //soundPoolクラスのインスタンスとサウンドファイルのリソースIDを保持するプロパティを宣言
    private lateinit var soundPool: SoundPool
    private var soundResId = 0

    //innerを先頭につけることによって、インナークラスになり外部の変数（binding）を参照できるようになる
